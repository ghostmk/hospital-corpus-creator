...
url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+lat1+','+long1+'&radius='+radius+'&type=hospital&key=AIzaSyByoWKvAT9C_5uwRQJfUlwFF1jkO_kbOoc'
